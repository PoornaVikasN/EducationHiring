...
import { JobDepartment, Role, Subject } from '../../../lib/shared/enums';
import { formatLpa } from '../../../lib/shared/constants';
import { enumComboboxOptions, enumLabel } from '../../../lib/utils/enum-options';

const EXPERTISE_FILTER_OPTIONS = [
  { value: '', label: 'All Specialties' },
  ...enumComboboxOptions(Subject),
];

const DEPARTMENT_FILTER_OPTIONS = [
  { value: '', label: 'All Departments' },
  ...enumComboboxOptions(JobDepartment),
];
...
export default function JobsPage() {
  ...
  const { data, isLoading, error } = useQuery({
    queryKey: ['jobs', debouncedSearch, debouncedCity, expertise, department, page],
  ...
  const activeFilterCount = [expertise, department, debouncedCity].filter(Boolean).length;
