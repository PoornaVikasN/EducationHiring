...
const SUPPORT_EMAIL = 'support@schoolteacher.co.in';
...
const SEEDS: SeedPage[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: '6. Data Retention', body: `<p>We retain your account data for as long as your account is active. If you request account deletion, your personal profile data is deactivated within 30 days. Job posting records and payment transaction references may be retained for up to 7 years for legal and accounting compliance.</p>` },
      { heading: '7. Your Rights', body: `<p>You have the right to:</p><ul><li>Access and download the personal data we hold about you.</li><li>Correct inaccurate data via your profile settings.</li><li>Request deletion of your account and associated data.</li><li>Opt out of non-essential communications via Settings.</li></ul><p>To exercise any of these rights, contact us at <a href="mailto:${SUPPORT_EMAIL}">${SUPPORT_EMAIL}</a>.</p>` },
      { heading: '8. Security', body: `<p>We use industry-standard security practices — HTTPS encryption, hashed passwords (bcrypt), and role-based access controls. However, no internet transmission is 100% secure. Please use a strong, unique password and notify us immediately if you suspect unauthorized account access.</p>` },
      { heading: '9. Changes to This Policy', body: `<p>We may update this Privacy Policy as the platform evolves. Significant changes will be communicated via email. Continued use of the platform after updates constitutes acceptance of the revised policy.</p>` },
      { heading: '10. Contact', body: `<p>For privacy-related queries, write to us at <a href="mailto:${SUPPORT_EMAIL}">${SUPPORT_EMAIL}</a>.</p>` },
    ],
  },
];
